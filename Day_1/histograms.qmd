...
subtitle: "Exploring numeric data with the gf_plot() functions"
format: revealjs
execute: 
  echo: true
---
...
Work in a new .rmd file.

<br>

The .rmd file you can save.

## Load the Libraries

If you are working in a .rmd file you will need to put these two lines of code in the set up chunk.
