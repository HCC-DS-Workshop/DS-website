...
If you are using a different problem set and `prop.test()` doesn't work, you could check out `binom.test()` which is also in Mosaic \n.
...
Is the population parameter for the proportion of students 0.30?
...
There are two (or three) statistics related cheat sheets in the resources tab.
