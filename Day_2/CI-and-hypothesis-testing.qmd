...
subtitle: "Also getting data into R"
format: revealjs
editor: visual
...
Give your data a good variable name.
...
Find if the mean salary for a doctor is 90 thousand dollars.

. . .

```{r}
#| echo: TRUE
t.test(~salary, mu=90,alternative = "t")
```

Notice there is no `data=` argument.

## How to get data into R. Method 2: spreadsheets. {.smaller}

[Here's a spreadsheet](https://www.mosaic-web.org/go/datasets/zebra-mussels.csv) on zebra mussel from mosaic-web.org.

1.  Download the spreadsheet.

2a. If R is installed on your computer, find your fine in the files pane.
...
note: If using this file for an Rmd document, copy and paste the code that appears in the console.
